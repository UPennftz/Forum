<template>
  <div class="register">
    <el-form ref="registerForm" :model="registerForm" :rules="registerRules" class="register-form">
      <h3 class="title">Forum backend management system</h3>
      ...
      this.$refs.registerForm.validate(valid => {
        if (valid) {
          ...
          register(this.registerForm).then(res => {
            ...
            this.$alert("<font color='red'>Congratulations, your account " + username + " has been successfully registered！</font>", 'SystemPrompts', {
