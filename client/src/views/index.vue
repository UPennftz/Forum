    ...
    <el-row :gutter="32">
      <el-col :xs="12" :sm="6" style="text-align: center;margin-bottom: 32px;">
        <el-card shadow="hover" @click.native="selectCard (0)">
          <p style="font-size: 15px; font-weight: bold;">Total number of people</p>
      ...
      <el-col :xs="12" :sm="6" style="text-align: center;margin-bottom: 32px;">
        <el-card shadow="hover" @click.native="selectCard (1)">
                    <p style="font-size: 15px; font-weight: bold;">Total number of categories</p>
      ...
      <el-col :xs="12" :sm="6" style="text-align: center;margin-bottom: 32px;">
        <el-card shadow="hover" @click.native="selectCard (2)">
                    <p style="font-size: 15px; font-weight: bold;">Number of new posts today</p>
      ...
      <el-col :xs="12" :sm="6" style="text-align: center;margin-bottom: 32px;">
        <el-card shadow="hover" @click.native="selectCard (3)">
                    <p style="font-size: 15px; font-weight: bold;">Today's number of online users</p>
...
<div class="input-group">
  ...
  <el-button type="primary" @click="getAddUserData">Set</el-button>
</div>
