<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="DictionaryName" prop="dictType">
      ...
      <el-form-item label="DictionaryTags" prop="dictLabel">
        <el-input
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="cssClass" prop="cssClass">
          <el-input v-model="form.cssClass" placeholder="Please enter style attributes" />
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        dictValue: [
          { required: true, message: "The data key value cannot be empty", trigger: "blur" }
        ],
        dictSort: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('Are you sure you want to delete the data item whose dictionary code is"' + dictCodes + '"？').then(function() {
