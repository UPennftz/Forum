<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="noticeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="PostTime" align="center" prop="createTime" width="100">
        <template slot-scope="scope">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="Announcement Type" prop="noticeType">
              <el-select v-model="form.noticeType" placeholder="Please select the announcement type">
                <el-option
                  v-for="dict in dict.type.sys_notice_type"
                  :key="dict.value"
                  :label="dict.label"
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getNotice(noticeId).then(response => {
        ...
        this.open = true;
        this.title = "Modification Announcement";
      });
    },
    /** 提交按钮 */
    submitForm: function() {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('Are you sure to delete the data item with announcement number"' + noticeIds + '"？').then(function() {
