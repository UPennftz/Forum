<template>
  <!-- 授权用户 -->
  <el-dialog title="SelectUser" :visible.sync="visible" width="800px" top="5vh" append-to-body>
    ...
    <el-row>
      <el-table @row-click="clickRow" ref="table" :data="userList" @selection-change="handleSelectionChange" height="260px">
        ...
        <el-table-column label="number" prop="phonenumber" :show-overflow-tooltip="true" />
...
export default {
  ...
  methods: {
    ...
    handleSelectUser() {
      ...
      if (userIds == "") {
        this.$modal.msgError("Please select the user to assign");
        return;
      }
