<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="perms" label="PermissionFlag" :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="component" label="ComponentPath" :show-overflow-tooltip="true"></el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="680px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          <el-col :span="24">
            <el-form-item label="PrevMenu" prop="parentId">
              <treeselect
                v-model="form.parentId"
                :options="menuOptions"
                :normalizer="normalizer"
                :show-count="true"
                placeholder="Select the previous menu"
              />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="MenuType" prop="menuType">
              <el-radio-group v-model="form.menuType">
                ...
                <el-radio label="C">Carte</el-radio>
          ...
          <el-col :span="12" v-if="form.menuType != 'F'">
            <el-form-item prop="isFrame">
              <span slot="label">
                <el-tooltip content="If you choose External Link, the routing address needs to start with `http(s)://`" placement="top">
          ...
          <el-col :span="12" v-if="form.menuType != 'F'">
            <el-form-item prop="path">
              <span slot="label">
                <el-tooltip content="The route address to be accessed, such as: `user`. If the external network address needs to be accessed internally, it should start with `http(s)://`" placement="top">
                <i class="el-icon-question"></i>
                </el-tooltip>
                RouAddr
              </span>
          ...
          <el-col :span="12" v-if="form.menuType == 'C'">
            <el-form-item prop="query">
              ...
              <span slot="label">
                <el-tooltip content='Access the default parameters passed to the route, such as：`{"id": 1, "name": "ry"}`' placement="top">
                <i class="el-icon-question"></i>
                </el-tooltip>
                RouteParameters
              </span>
...
export default {
  ...
  methods: {
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      this.$modal.confirm('Are you sure you want to delete the data item named"' + row.menuName + '"？').then(function() {
