  ...
  <div class="app-container">
      <!--用户数据-->
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="NO." align="center" key="userId" prop="userId" v-if="columns[0].visible" />
          ...
          <el-table-column label="IDNumber" align="center" key="phonenumber" prop="phonenumber" v-if="columns[3].visible" width="120" />
          <el-table-column label="Status" align="center" key="status" v-if="columns[4].visible">
          ...
          <el-table-column label="PostTime" align="center" prop="createTime" v-if="columns[5].visible" width="160">
            <template slot-scope="scope">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="Name" prop="nickName">
              <el-input v-model="form.nickName" placeholder="Please enter your user nickname" maxlength="30" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item v-if="form.userId == undefined" label="User Account" prop="userName">
              <el-input v-model="form.userName" placeholder="Please enter your user account" maxlength="30" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="IDNumber" prop="phonenumber">
              <el-input v-model="form.phonenumber" placeholder="Please enter IDNumber" maxlength="11" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="Email" prop="email">
              <el-input v-model="form.email" placeholder="Please enter your email" maxlength="50" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item v-if="form.userId == undefined" label="User Password" prop="password">
              <el-input v-model="form.password" placeholder="Please enter your password" type="password" maxlength="20" show-password/>
            </el-form-item>
          </el-col>
            <el-col :span="12">
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { key: 3, label: `IDNumber`, visible: true },
        { key: 4, label: `Status`, visible: true },
        { key: 5, label: `PostTime`, visible: true }
      ],
      // 表单校验
      rules: {
        userName: [
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$modal.confirm('Are you sure"' + text + '""' + row.userName + '"this user？').then(function() {
      ...
      this.$prompt('Please enter"' + row.userName + '"new password', "Hint", {
        ...
        inputErrorMessage: "User password length must be between 5 and 20"
          ...
          resetUserPwd(row.userId, value).then(response => {
            this.$modal.msgSuccess("The modification was successful, the new password is:" + value);
          });
        }).catch(() => {});
    },
    /** 分配角色操作 */
