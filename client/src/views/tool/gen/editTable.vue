<template>
  <el-card>
    <el-tabs v-model="activeName">
      ...
      <el-tab-pane label="columnInfo" name="columnInfo">
        <el-table ref="dragTable" :data="columns" row-key="columnId" :max-height="tableHeight">
          ...
          />
          <el-table-column label="columnComment" min-width="10%">
          ...
          <el-table-column label="javaField" min-width="10%">
            <template slot-scope="scope">
          ...
          <el-table-column label="QueryMethod" min-width="10%">
            <template slot-scope="scope">
          ...
          <el-table-column label="type" min-width="12%">
            <template slot-scope="scope">
      ...
      <el-tab-pane label="genInfo" name="genInfo">
        <gen-info-form ref="genInfo" :info="info" :tables="tables" :menus="menus"/>
      </el-tab-pane>
    </el-tabs>
    <el-form label-width="100px">
      <el-form-item style="text-align: center;margin-left:-100px;margin-top:10px;">
        <el-button type="primary" @click="submitForm()">Set</el-button>
    ...
    submitForm() {
      ...
      Promise.all([basicForm, genForm].map(this.getFormPromise)).then(res => {
        ...
        if (validateResult) {
          ...
          this.$modal.msgError("The form verification failed, please recheck the submitted content");
        }
      });
    },
    getFormPromise(form) {
