...
@ApiResource(name = "Resource Management", resBizType = ResBizTypeEnum.SYSTEM)
public class SysApiResourceController {
     ...
     * 加载对应角色资源列表树
     */
    @GetMapping(value = "/roleApiTreeselect/{roleId}", name = "Resource Management-Load the corresponding character resource list tree")
     ...
     * 修改对应角色api资源
     */
    @PutMapping(value = "/roleApi", name = "Modify the corresponding role API resources")
