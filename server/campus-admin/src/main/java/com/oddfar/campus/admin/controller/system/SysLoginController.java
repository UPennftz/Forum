...
@RestController
@RequestMapping
@ApiResource(name = "Login Routing", resBizType = ResBizTypeEnum.SYSTEM)
public class SysLoginController {
     ...
     * @return 结果
     */
    @PostMapping(value = "/login", name = "Login Method")
     ...
     * @return 用户信息
     */
    @GetMapping(value = "getInfo", name = "Get user information")
    public R getInfo() {
     ...
     * @return 路由信息
     */
    @GetMapping(value = "getRouters", name = "Get routing information")
    public R getRouters() {
