...
public class SecurityUtils {
    ...
    public static Long getUserId() {
        try {
            ...
            throw new ServiceException("Exception in getting user ID", HttpStatus.UNAUTHORIZED);
        }
    }
    ...
    public static String getUsername() {
        try {
            ...
            throw new ServiceException("Obtaining user account exception", HttpStatus.UNAUTHORIZED);
        }
    }
    ...
    public static LoginUser getLoginUser() {
        try {
            ...
            if (!loginUser.getUser().getStatus().equals(UserConstants.NORMAL)) {
                throw new ServiceException("User banned", HttpStatus.FORBIDDEN);
            }
            return loginUser;
        } catch (Exception e) {
