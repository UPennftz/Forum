...
public class SysRoleEntity extends BaseEntity {
    ...
    @Size(min = 0, max = 30, message = "The character name cannot exceed 30 characters.")
    ...
    @Size(min = 0, max = 100, message = "The length of the permission character cannot exceed 100 characters")
