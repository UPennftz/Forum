...
public class LogoutSuccessHandlerImpl implements LogoutSuccessHandler {
    ...
    public void onLogoutSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication)
        ...
        if (StringUtils.isNotNull(loginUser)) {
            ...
            // 记录用户退出日志
            AsyncManager.me().execute(AsyncFactory.recordLogininfor(loginUser.getUsername(), loginUser.getUserId(), Constants.LOGOUT, "success"));
        }
        ServletUtils.renderString(response, JSON.toJSONString(R.error(HttpStatus.SUCCESS, "success")));
    }
}
